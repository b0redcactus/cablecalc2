...
(function () {
  ...
  function toXLSX(result, meta) {
    ...
    const rows = [
      ...
      ["Árnyékolás", r.screening === 'yes' ? "Igen (NYCWY/NAYCWY)" : "Nem (NYY/NAYY)"],
      ["Párhuzamos kábelek (N)", r.parallelN || 1],
      []
    ];
    ...
    if (N > 1) {
      rows.push(["Terhelhetőség / kábel", r.iN != null ? f(r.iN, 1) + " A" : "–"]);
      rows.push(["Áramkör össz-terhelhetősége (" + N + " db)", r.iN_total != null ? f(r.iN_total, 1) + " A" : "–"]);
    } else {
