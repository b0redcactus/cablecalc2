...
// ─────────────────────────────────────────────────────────────────────────────
tests.push(
  // Table 8 — PVC 0,6/1 kV soil
  { name: "LV PVC 240 Cu soil 3-core",  got: CALC.lookupBaseAmpacity({insulation:'PVC',voltage:'0.6/1',material:'Cu',section:'240',arrangement:'three_core',installation:'soil'}), want: 473 },
  { name: "LV PVC 240 Al soil 3-core",  got: CALC.lookupBaseAmpacity({insulation:'PVC',voltage:'0.6/1',material:'Al',section:'240',arrangement:'three_core',installation:'soil'}), want: 364 },
  { name: "LV PVC 95 Cu soil flat",     got: CALC.lookupBaseAmpacity({insulation:'PVC',voltage:'0.6/1',material:'Cu',section:'95',arrangement:'flat_7',installation:'soil'}), want: 286 },
  // Table 9 — PVC 0,6/1 kV air
  { name: "LV PVC 95 Cu air 3-core",    got: CALC.lookupBaseAmpacity({insulation:'PVC',voltage:'0.6/1',material:'Cu',section:'95',arrangement:'three_core',installation:'air'}), want: 246 },
  { name: "LV PVC 150 Al air 3-core",   got: CALC.lookupBaseAmpacity({insulation:'PVC',voltage:'0.6/1',material:'Al',section:'150',arrangement:'three_core',installation:'air'}), want: 246 },
  // Table 10 — XLPE 0,6/1 kV soil
  { name: "LV XLPE 240 Cu soil 3-core", got: CALC.lookupBaseAmpacity({insulation:'XLPE',voltage:'0.6/1',material:'Cu',section:'240',arrangement:'three_core',installation:'soil'}), want: 517 },
  { name: "LV XLPE 95 Al soil flat",    got: CALC.lookupBaseAmpacity({insulation:'XLPE',voltage:'0.6/1',material:'Al',section:'95',arrangement:'flat_7',installation:'soil'}), want: 238 },
  // Table 11 — XLPE 0,6/1 kV air
  { name: "LV XLPE 240 Cu air flat",    got: CALC.lookupBaseAmpacity({insulation:'XLPE',voltage:'0.6/1',material:'Cu',section:'240',arrangement:'flat_7',installation:'air'}), want: 604 },
  { name: "LV XLPE 50 Al air 3-core",   got: CALC.lookupBaseAmpacity({insulation:'XLPE',voltage:'0.6/1',material:'Al',section:'50',arrangement:'three_core',installation:'air'}), want: 149 },
  // Sanity: Al 1.5 mm² doesn't exist (Al not manufactured in such small sections)
  { name: "LV PVC 1.5 Al soil → null",  got: CALC.lookupBaseAmpacity({insulation:'PVC',voltage:'0.6/1',material:'Al',section:'1.5',arrangement:'three_core',installation:'soil'}), want: null },
  // PVC 3.6/6 kV is not tabulated in MSZ 13207 → null (manual entry)
  { name: "PVC 3.6/6 kV not tabulated → null", got: CALC.lookupBaseAmpacity({insulation:'PVC',voltage:'3.6/6',material:'Cu',section:'240',arrangement:'three_core',installation:'soil'}), want: null }
);
